...
export function TopicListPage(props: TopicListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTopics({
        relations: ['organization', 'question_generation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('question_generation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'question_generation',
          header: 'Question Generation',
          accessorKey: 'question_generation',
          cell: ({ row: { original: record } }: any) => record?._count?.question_generation,
        }
      : null,
