...
import { getQuestionGenerationById } from 'apiSdk/question-generations';
import { QuestionGenerationInterface } from 'interfaces/question-generation';

function QuestionGenerationViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Question Generation Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('question_generation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/question-generations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Number Of Questions" text={data?.number_of_questions} />
