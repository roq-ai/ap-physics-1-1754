            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('question', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/questions/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Question Topic" text={data?.question_topic} />
                ...
                {hasAccess('template', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Template"
                    text={
                      <Link as={NextLink} href={`/templates/view/${data?.template?.id}`}>
                        {data?.template?.name}
                      </Link>
                    }
                  />
