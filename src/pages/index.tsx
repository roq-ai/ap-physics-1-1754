  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to AP Physics 1 - Streamlining Your Study Process. Our application generates customized multiple choice questions based on your chosen topic. Your key to mastering Kinematics, Dynamics, or Circular Motion and Gravitation is just a click away."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjk0MzE3MjY5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to AP Physics 1 - Streamlining Your Study Process. Our application generates customized multiple choice questions based on your chosen topic. Your key to mastering Kinematics, Dynamics, or Circular Motion and Gravitation is just a click away.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Content Creator" type="content-creator" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
